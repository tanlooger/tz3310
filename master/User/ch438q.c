...
{
//	uint16_t	P_data;
//	P_data=GPIO_ReadOutputData(GPIOD);
//	P_data=0xff00||P_data;
//	GPIO_Write(GPIOD,P_data);
//	return;
	GPIO_InitTypeDef gpio;
	gpio.GPIO_Pin = CH438_Pin_D0 |CH438_Pin_D1 |CH438_Pin_D2 |
		CH438_Pin_D3 |CH438_Pin_D4 |CH438_Pin_D5 |CH438_Pin_D6 |CH438_Pin_D7;
	gpio.GPIO_Mode = GPIO_Mode_IPU;//IPU;GPIO_Mode_IPD;//GPIO_Mode_IN_FLOATING;
...
void ch438_stm32_gpio_output(void)
{
	...
	gpio.GPIO_Pin = CH438_Pin_D0 |CH438_Pin_D1 |CH438_Pin_D2 |
		CH438_Pin_D3 |CH438_Pin_D4 |CH438_Pin_D5 |CH438_Pin_D6 |CH438_Pin_D7;
	gpio.GPIO_Mode = GPIO_Mode_Out_PP;//GPIO_Mode_Out_OD;//
	gpio.GPIO_Speed = GPIO_Speed_10MHz;
	GPIO_Init( GPIOD, &gpio );	
}
...
{
	uint8_t data=0;
	uint16_t P_data,P_data2;
	P_data2=reg;
	P_data2=P_data2<<8;
	P_data2=P_data2&0xff00;
	P_data=GPIO_ReadOutputData(GPIOD);
	P_data=P_data&0x00ff;
	P_data=P_data|P_data2;
//	GPIO_WriteBit(GPIOB, CH438_Pin_ALE, Bit_RESET);
	...
	P_data=GPIO_ReadInputData(GPIOD);
	data=(char)(P_data>>8);
...
{
	uint16_t P_data,P_data2,P_data3;
	P_data2=reg;
	P_data3=value;
	P_data2=P_data2<<8;
	P_data2=P_data2&0xff00;
	P_data3=P_data3<<8;
	P_data3=P_data3&0xff00;
	P_data=GPIO_ReadOutputData(GPIOD);
	P_data=P_data&0x00ff;
	P_data2=P_data|P_data2;
	P_data3=P_data|P_data3;
//	GPIO_WriteBit(GPIOB, CH438_Pin_ALE, Bit_RESET);
	GPIO_WriteBit(GPIOB, CH438_Pin_ALE, Bit_SET);
	GPIO_WriteBit(GPIOB, CH438_Pin_WR, Bit_SET);
	GPIO_WriteBit(GPIOB, CH438_Pin_RD, Bit_SET);
	GPIO_Write(GPIOD,P_data2);
	GPIO_WriteBit(GPIOB, CH438_Pin_ALE, Bit_RESET);
//	GPIO_WriteBit(GPIOB, CH438_Pin_RD, Bit_SET);
	ch438_stm32_gpio_output();
	__NOP();
...
{
	ch438_reg_write(CH438_BASE_ADDR[serial_port] + CH438_REG_IIR_FCR, 0x01);//FIFO
